...
function MainPage(){
    ...
    return (
        <>
            ...
            <div className={desktopView? "container main-body bg-green-400": "vertical-container main-body bg-green-400"}>
<Contacts allUsers={allUsers} handleChatWith={handleChatWith} show={showItem.contacts} />
<ChatsContainer me={me} they={they} desktopView={desktopView} show={showItem.chats} />

<button className="toggle-btn" onClick={toggleItemToShow}>
    {showItem.contacts ? "Show Chats" : "Show Contacts"}
</button>
</div>
</>
);
